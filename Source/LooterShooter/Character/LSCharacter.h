...
public:
	...
	{
		return (EquipmentManager->GetCurrentWeaponInstance() != nullptr) ? EquipmentManager->GetCurrentWeaponInstance()->GetMaxRange() : AttackRange;
	}
