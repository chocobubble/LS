...
class ProtoTest final :
 ...
 public:
  ...
  ~ProtoTest() override;
  explicit PROTOBUF_CONSTEXPR ProtoTest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ProtoTest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
// int32 num = 1;
inline void ProtoTest::clear_num() {
  _impl_.num_ = 0;
}
inline int32_t ProtoTest::_internal_num() const {
  return _impl_.num_;
}
inline int32_t ProtoTest::num() const {
  // @@protoc_insertion_point(field_get:ProtoTest.num)
  return _internal_num();
}
inline void ProtoTest::_internal_set_num(int32_t value) {
  
  _impl_.num_ = value;
}
inline void ProtoTest::set_num(int32_t value) {
  _internal_set_num(value);
  // @@protoc_insertion_point(field_set:ProtoTest.num)
}
