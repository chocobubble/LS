...
PROTOBUF_CONSTEXPR ProtoTest::ProtoTest(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.num_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct ProtoTestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ProtoTestDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ProtoTestDefaultTypeInternal() {}
  union {
    ProtoTest _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ProtoTestDefaultTypeInternal _ProtoTest_default_instance_;
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::ProtoTest, _impl_.num_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::ProtoTest)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::_ProtoTest_default_instance_._instance,
};

const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\"\030\n\tProtoTest\022\013\n\003num\030\001 \001(\005b\006"
  "proto3"
  ;
static ::_pbi::once_flag descriptor_table_test_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 46, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
ProtoTest::ProtoTest(const ProtoTest& from)
  ...
  ProtoTest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void ProtoTest::SharedCtor(
...
inline void ProtoTest::SharedDtor() {
...
const char* ProtoTest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* ProtoTest::_InternalSerialize(
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ProtoTest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ProtoTest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ProtoTest::GetClassData() const { return &_class_data_; }


void ProtoTest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ProtoTest*>(&to_msg);
  auto& from = static_cast<const ProtoTest&>(from_msg);
...
template<> PROTOBUF_NOINLINE ::ProtoTest*
Arena::CreateMaybeMessage< ::ProtoTest >(Arena* arena) {
